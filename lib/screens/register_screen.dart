...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  // Premium Framework Colors matching Login Screen
  ...
  Future<void> _register() async {
    ...
    if (result == null) {
        ...
        SnackBar(
          content: Row(
            children: const [
              ...
              SizedBox(width: 10),
              Text("Registration Successful! Please login.", style: TextStyle(fontWeight: FontWeight.w500)),
            ],
          ),
      ...
      // Use declarative routing to switch stacks cleanly across platforms
      context.go('/login');
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Join FitTrack Pro to map your performance metrics",
                      style: const TextStyle(color: _textSecondary, fontSize: 13, fontWeight: FontWeight.w400),
                    ...
                    _buildInputField(
                      ...
                      validator: (value) {
                        if (value == null || value.trim().isEmpty) {
                          return "Name parameter cannot remain null.";
                        }
                        if (value.trim().length < 2) {
                          return "Please enter a valid full name layout.";
                        }
                        return null;
                      },
                    ),
                    ...
                    // Registration Form Execution Button
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _isLoading
                            ...
                            : const Text("Register Profile", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, letterSpacing: 0.2)),
                      ),
                    ),
                    const SizedBox(height: 24),

                    // Bottom Screen Switch Navigator Ref
                    Row(
